...
import chart11 from '../public/charts/chart11.png'
    ...
    items: [
      {
        ...
        range: null,
        paragraphs: [`Let's look closer at our Signature Fund to understand its workings. Developing a complete robo-advisory trading system requires a solid grasp of the market. This means assessing risks, analyzing the behavior of major Bitcoin players, understanding crypto exchanges, and keeping track of key global economic factors and events.`],
        picture: [{
          url: chart9,
      ...
      },
      {
        ...
        picture: [
          ...
          {
            url: chart3,
            firstSetOfParagraphs: [`Similarly, Bot5 works in tandem with other bots, concentrating on evaluating the risk magnitude arising from exchanges. This emphasis is crucial, as crypto exchanges hold significant sway over price fluctuations.`]
          },
          {
            url: chart4,
            ...
            firstSetOfList: [
              {
                listItems: [`Predicting the magnitude of the forthcoming Pump/Dump,`, `Estimating the duration of the next Pump/Dump, and`, `Suggesting suitable position sizing based on the aggregated risk level of the current market situation.`],
              }
            ],
          ...
          {
            url: chart6,
            firstSetOfParagraphs: [`Now, let’s see how the model can benefit a trader or any trading algorithm to help them measure the market’s reserved risk simultaneously, improving their performance and helping them make more accurate decisions.`, `As an illustration, we will opt for a straightforward trading strategy employing the Moving Average Convergence Divergence (MACD) indicator to exclusively generate sell signals. This strategy will be assessed over a five-year span, encompassing historical daily price data for Bitcoin from March 2018 to September 2023. Our aim is to enhance its efficacy through the utilization of our model as an observer of the signals generated by the strategy. We commence with an initial capital of $1,000 and implement a policy that restricts the strategy from allocating more than 50% of its capital to any single trade.`]
          }
        ]
      },
      {
